"""
Django settings for docker_drf project.
...
WSGI_APPLICATION = 'docker_drf.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'docker_drf/static'),
]
...
THUMBNAIL_ALIASES = {
    '': {
        'small': {
            'size': (700, 700), 'detail': True, 'crop': True, 'upscale': True,
        },
    },
}
